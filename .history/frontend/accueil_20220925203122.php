...
$saisonsInformations = array(
    ["slogan" => "Meilleur Vetement pour femme bbb", "slogan2" => "La purete de l'ame ne peut etre vu que par Dieu", "url" => "../assets/images/sweat-hood.jpg"],
    ["slogan" => "Meilleur Vetement pour femme jk", "slogan2" => "La purete de l'ame ne peut etre vu que par Dieu", "url" => "../assets/images/casquette.jpg"],
    ["slogan" => "Meilleur Vetement pour femme n", "slogan2" => "La purete de l'ame ne peut etre vu que par Dieu", "url" => "../assets/images/RedPant.jpg"],
                            ...
                            <div class='hover-content'>
                                ...
                                echo "</p>
                                    <div class='main-border-button'>
                                        <a href=saisons.php?idsaison=";echo $saisons[$x]['id']; echo">entrer</a>
                                    </div>
                                </div>
                            </div>
                            <img src='";
