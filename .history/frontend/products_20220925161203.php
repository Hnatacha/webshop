...
$products = array(
    ["name"=>"Prod1","desc"=>"desc Prod1", "price"=> 120, "url"=> "../assets/images/men-01.jpg", "rate"=>3],
    ["name"=>"Prod2","desc"=>"desc Prod2", "price"=> 182, "url"=> "../assets/images/men-02.jpg"],
    ["name"=>"Prod11","desc"=>"desc Prod3", "price"=> 122, "url"=> "../assets/images/men-03.jpg"],
    ["name"=>"Prod111","desc"=>"desc Prod4", "price"=> 127, "url"=> "../assets/images/women-01.jpg"],
    ["name"=>"Prod10","desc"=>"desc Prod5", "price"=> 123, "url"=> "../assets/images/women-02.jpg"],
    ["name"=>"Prod6","desc"=>"desc Prod6", "price"=> 120, "url"=> "../assets/images/women-02.jpg"],
    ["name"=>"Prod22","desc"=>"desc Prod7", "price"=> 250, "url"=> "../assets/images/men-01.jpg"],
    ["name"=>"Prodi","desc"=>"desc Prod8", "price"=> 240, "url"=> "../assets/images/kid-01.jpg"],
    ["name"=>"Prod3","desc"=>"desc Prod9", "price"=> 121, "url"=> "../assets/images/kid-02.jpg"],
    ["name"=>"Prod102","desc"=>"desc Prod10", "price"=> 152, "url"=> "../assets/images/kid-03.jpg"],
    ["name"=>"Prod71","desc"=>"desc Prod11", "price"=> 121, "url"=> "../assets/images/men-03.jpg"],
    ["name"=>"Prod61","desc"=>"desc Prod12", "price"=> 402, "url"=> "../assets/images/women-01.jpg"],
    ["name"=>"Prod172","desc"=>"desc Prod13", "price"=> 920, "url"=> "../assets/images/men-02.jpg"]
    );
?>
                ...
                for ($x = 0; $x < sizeof($products); $x++) {
                    echo "<div class='col-lg-4 box'>
                            ...
                            <div class='thumb'>
                                ...
                                <img src='";echo $products[$x]['url']; echo "' alt=''>
                            </div>
                            <div class='down-content'>
                                <h4>";echo $products[$x]['name']; echo "</h4>
                                    <div class='row'>
                                        <span class='prix'>
                                        ";echo $products[$x]['price']; echo " <sup>€</sup>
                                        </span>
                                        <span class='reservation' id='reservation' positionCourrante=$x quantite='1'>
                                            <span>reserver</span>
                                        </span>
                                    </div>
                                    <ul class='stars'><li><i class='fa fa-star'></i></li>
