...
$produits = affichageParSaison("produit", $connexion, "id=2");
$produitParPage = 9;
...
$elements = paginationParSaison("produit", $premiereEntree, $produitParPage, $connexion, "id=2");
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2>Nos derniers Produits d'<?php echo$saisonSelectionne["nom"] ?></h2>
