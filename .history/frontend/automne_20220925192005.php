...
$saisonSelectionne = affichageParIdentifiant("saison",$connexion, "id=2"); // exemple de retour $res5[1,"automne"]; 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2>Nos derniers Produits d'<?php $saisonSelectionne[0]["nom"] ?></h2>
