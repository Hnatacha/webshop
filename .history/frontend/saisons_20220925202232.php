...
echo "id saisonnn ".$_GET['idsaison'];
...
$produits = affichageParSaison("produit", $connexion, "saison_id='".isset($_GET['idsaison'])."'");
$produitParPage = 9;
...
$saisonSelectionne = affichageParIdentifiant("saison",$connexion, "id='".isset($_GET['idsaison'])."'"); // exemple de retour $res[[1,"automne"]]; 
echo 'valll::::' .$saisonSelectionne;
$premiereEntree = ($pageActuelle - 1) * $produitParPage; // On calcul la première entrée à lire
$elements = paginationParSaison("produit", $premiereEntree, $produitParPage, $connexion, "saison_id='".isset($_GET['idsaison'])."'");
?>
