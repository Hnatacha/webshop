<?php 
$saisons = array(
    ["slogan" => "Meilleur Vetement pour femme", "slogan2" => "La purete de l'ame ne peut etre vu que par Dieu", "price" => 120, "url" => "../assets/images/sweat-hood.jpg"],
    ["name" => "Prod2", "desc" => "desc Prod2", "price" => 182, "url" => "../assets/images/casquette.jpg"],
