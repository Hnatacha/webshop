  ...
  <div class="content">
    <div class="container">
      <div class="row align-items-center">
        ...
        // Liste des produits
        $admin_vues = mysqli_query($conn, "SELECT admin_utilisateur.username, compteur.vues FROM compteur JOIN admin_utilisateur ON compteur.admin_id = admin_utilisateur.id");
            ...
            <table class="table">
              ...
              <tbody>
                ...
                while ($admin_vue = mysqli_fetch_assoc($admin_vues)) {
                    ...
                    ?>
                    <tr>
                      <td class="text-left"><?= $admin_vue['username'] ?></td>
