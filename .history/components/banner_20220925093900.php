                    ...
                    <div style="float: right;">
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="pages/products.php">vetements</a></li>
                                    <li><a href="pages/accessoire.php">Accessoire</a></li>
                                </ul>
                            </li>
                            <li class="scroll-to-section"><a href="pages/membre.php">Membre</a></li>
                            <li class="scroll-to-section"><a href="pages/business.php">Affaire</a></li>
                            <li class="scroll-to-section"><a href="pages/contact.php">Contact </a></li>
                        </ul>
                    </div>
