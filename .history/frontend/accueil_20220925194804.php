...
$saisons = array(
    ...
    ["name" => "Prod2", "desc" => "desc Prod2", "url" => "../assets/images/casquette.jpg"],
    ["name" => "Prod11", "desc" => "desc Prod3", "url" => "../assets/images/RedPant.jpg"],
    ["name" => "Prod111", "desc" => "desc Prod4","url" => "../assets/images/sweat-t-shirt.jpg", "rate" => 2]
);
?>
