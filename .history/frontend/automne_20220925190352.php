...
//cette methode permet l'affichage des enregistrement d'une table en fct de l'
function affichage($table, $con, $idElement)
{
    $sql = "SELECT * FROM $table WHERE $idElement ORDER BY id DESC";
