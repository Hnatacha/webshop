                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="right-content">
                            <div class="row">
                            <?php
                for ($x = 01; $x < sizeof($saisons); $x++) {  
                    echo "<div class='col-lg-6'>
                    <div class='right-first-image'>
                        <div class='thumb'>
                            <div class='inner-content'>
                                <h4>'";echo $saisons[$x]['nom']; echo "'</h4>
                                <span>'";echo $saisonsInformations[$x]['slogan']; echo "'</span>
                            </div>
                            <div class='hover-content'>
                                <div class='inner'>
                                    <h4>'";echo $saisons[$x]['nom']; echo "'</h4>
                                    <p>'";echo $saisonsInformations[$x]['slogan2']; echo "'</p>
                                    <div class='main-border-button'>
                                        <a href=index.php?idsaison=$x>entrer</a>
                                    </div>
                                </div>
                            </div>
                            <img src='";echo $saisonsInformations[$x]['url']; echo "'>
                        </div>
                    </div>
                </div>"; 
                     ?>           
