            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2>Contact nous</h2>
                        <span>Genial, propre &amp; creative boutique</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-6">
                            <ul>
                                <li>Store Location:<br><span>Sunny Isles Beach, FL 33160, Mauritius</span></li>
                                <li>Phone:<br><span>230-58540705</span></li>
                                <li>Office Location:<br><span>Port louis</span></li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul>
                                <li>Work Hours:<br><span>07:30 AM - 9:30 PM Daily</span></li>
                                <li>Email:<br><span>webshoplowh@gmail.com</span></li>
