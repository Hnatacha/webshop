...
public function Pagination($table, $firstPage, $messageParPage, $boolean) {
    $sql = "SELECT * FROM $table  WHERE $boolean ORDER BY id DESC LIMIT $firstPage, $messageParPage ";
...
$produitParPage = 5;
$nombreDePages = ceil(sizeof($products) / $messagesParPage);
                ...
                for ($x = 0; $x < sizeof($products); $x++) {
                    ...
                    echo "' alt=''>
                            ...
                            <div class='down-content'>
                                <h4>";
                    echo $products[$x]['name'];
                    echo "</h4>
                                    <div class='row'>
                                        <span class='prix'>
                                        ";
                    echo $products[$x]['price'];
                    echo " <sup>€</sup>
                                        </span>
