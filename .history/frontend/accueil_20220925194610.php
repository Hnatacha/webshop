<?php 
$saisons = array(
    ["slogan" => "Meilleur Vetement pour femme", "slogan2" => "La purete de l'ame ne peut etre vu que par Dieu", "price" => 120, "url" => "../assets/images/sweat-hood.jpg../assets/images/casquette.jpg", "rate" => 4],
